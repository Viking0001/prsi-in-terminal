    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            {
                if (PocetKaretVRuce(hrac1_ruka) > 10 || PocetKaretVRuce(hrac2_ruka) > 10) { sirka = 4; vyska = 3; }
                else if (PocetKaretVRuce(hrac1_ruka) > 5 || PocetKaretVRuce(hrac2_ruka) > 5) { sirka = 8; vyska = 5; }
                else { sirka = 10; vyska = 7; }
                ...
                {
                    if (kartanastole % 8 == 0) { LizniKartu(lizaci_balicek, hrac1_ruka, 2); muzehrathrac2 = false; }
                    else if (kartanastole % 8 == 7) { muzehrathrac2 = false; }
                    else if (kartanastole % 8 == 5) { kartanastole = (VyberKartyProHrace(znaky)); }
                }
                Console.Clear();
                VypisStolu(kartanastole, balicek_karet, hrac1_ruka, hrac2_ruka, lizaci_balicek, vyska, sirka, znaky, pozicekurzoru, odhazovaci_balicek);
                muzehrathrac1 = true;
                ...
                if (PocetKaretVRuce(hrac2_ruka) != 0 && muzehrathrac2)
                {
                    ...
                    for (int i = 0; i < PocetKaretVRuce(hrac1_ruka) * 2; i++)
                    {
                        ...
                        if (MohuZahratKartu(kartanastole, JakaKartaJeOznacena(hrac1_ruka, nahodnakarta)))
                        {
                            ...
                            if (kartanastole % 8 == 0) { LizniKartu(lizaci_balicek, hrac2_ruka, 2); muzehrathrac1 = false; }
                            else if (kartanastole % 8 == 7) { muzehrathrac1 = false; }
                            else if (kartanastole % 8 == 5) { kartanastole = VyberKartyProPc(hrac1_ruka); }
                            break;
                        }
                    }
        ...
        static string StvorKarty(int znak, int cislo, string[] znaky, int sirka, int vyska, bool vibrana_karta)
        {
            ...
            string symbol;
            if (cislo == 10) { symbol = "X"; }
            else if (cislo == 11) { symbol = "J"; }
            else if (cislo == 12) { symbol = "Q"; }
            else if (cislo == 13) { symbol = "K"; }
            else if (cislo == 14) { symbol = "A"; }
            else { symbol = "" + cislo; }
        ...
        static int[] NactiSipku(int pozicekurzoru, int pocetKvruce, int kartanastole, int[] balicek_karet, int[] kartyhrac, int[] lizaci_balicek, int[] odhazovaci_balicek)
        {
            ...
            if (sipka == ConsoleKey.LeftArrow) { return new int[] { pozicekurzoru - 1, kartanastole }; }
            else if (sipka == ConsoleKey.RightArrow) { return new int[] { pozicekurzoru + 1, kartanastole }; }
            else if (sipka == ConsoleKey.Enter)
            {
        ...
        static int VyberKartyProHrace(string[] znaky)
        {
            ...
            while (sipka != ConsoleKey.Enter)
            {
                ...
                if (sipka == ConsoleKey.LeftArrow) { pozicekurzoru--; }
                else if (sipka == ConsoleKey.RightArrow) { pozicekurzoru++; }
            }
